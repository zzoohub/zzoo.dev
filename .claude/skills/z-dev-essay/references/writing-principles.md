...
**어조 — 겸손함이 기본이다**: 한국어 에세이는 영어와 톤이 다르다. 같은 내용이라도 한국어에서는 겸손한 문장이 훨씬 자연스럽고 설득력 있다. 이건 문화적 차이이지 약함이 아니다.

- "내가 발견한 건 ~이다" 대신 "~인 것 같다", "~라는 걸 알게 됐다"
- "이게 정답이다" 대신 "이런 방향이 맞지 않을까 싶다", "이게 더 나은 것 같다"
- 자기 성과를 말할 때도 담담하게. "엄청난 성과를 냈다" 대신 "운이 좋았다", "결과가 괜찮게 나왔다"
- 실수나 부족함을 솔직히 인정하는 문장이 한국어 에세이에서는 오히려 신뢰를 준다
- 독자에게 가르치려 드는 톤은 피한다. "~해야 한다"보다 "~하는 게 나았다" (자기 경험으로 전환)

영어 PG 스타일의 단정적 진술("X is wrong", "This is the answer")을 한국어로 그대로 옮기면 거만하게 들린다. 한국어에서는 같은 확신을 겸손한 표현으로 감싸는 게 네이티브 글쓰기다. 친구에게 설명하듯, 하지만 가볍지는 않게. 자기 경험에서 우러난 이야기처럼 써라.
